...
const sortNames = (arr) => {
  let newArr = arr.sort( (a, b) => a.charCodeAt() - b.charCodeAt());
  return newArr;
};
...
const alphabetizeBetter = (arr) => {
  let newArr = arr.sort(Intl.Collator().compare);
  //using to lower case does not work in some web languages. Intl collator compare is the best ES6 way to compare languages
  return newArr;
};
...
const sortPeople = (arr) => {
  let newArr = arr.sort( (a, b) => Intl.Collator().compare(a.lastName, b.lastName));
  return newArr;
};
...
const sortPeopleBetter = (arr) => {
  let newArr = arr.sort( (a, b) => Intl.Collator().compare(a.age, b.age));
  newArr = arr.sort( (a, b) => Intl.Collator().compare(a.firstName, b.firstName));
  newArr = arr.sort( (a, b) => Intl.Collator().compare(a.lastName, b.lastName));
  return newArr;
};
...
//   let newArr = arr.sort( (a, b) => arr.compare(a.dayOfWeek, b.dayOfWeek));
//   return newArr;
// };
