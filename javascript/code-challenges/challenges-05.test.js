...
const toLastNames = people => {
  let newArr = people.map(obj => `${obj.firstName} ${obj.lastName}`);
  return newArr;
};
...
const addValues = (arr) => {
  let newAcc = arr.reduce((accumulator, value) => accumulator + value, 0);
  return newAcc;
};
...
const addPurchases = (arr) => {
  let newAcc = arr.reduce((accumulator, value) => accumulator + value.purchasePrice, 0);
  return newAcc;
};
...
const countNumberOfElements = (arr) => {
  let newAcc = arr.reduce((accumulator, value, index) => accumulator = index + 1, 0);
  return newAcc;
};
...
const returnNames = (arr) => {
  let newAcc = arr.reduce((accumulator, value) => {
